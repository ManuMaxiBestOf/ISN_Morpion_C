...
IA intelligence_artificielle_emp(JEU tmq)
{
    ...
    int z = 0;
    int k;
    if ((tmq.tab[0][0] == tmq.tab[0][1] && tmq.tab[0][0] == 1 && tmq.tab[0][2] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[1][2] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    else    if ((tmq.tab[0][2] == tmq.tab[0][1] && tmq.tab[0][2] == 1 && tmq.tab[0][0] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[1][0] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    else    if ((tmq.tab[0][0] == tmq.tab[1][0] && tmq.tab[0][0] == 1 && tmq.tab[2][0] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[2][1] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    else    if ((tmq.tab[1][0] == tmq.tab[2][0] && tmq.tab[1][0] == 1 && tmq.tab[0][0] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[0][1] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    else    if ((tmq.tab[2][0] == tmq.tab[2][1] && tmq.tab[2][0] == 1 && tmq.tab[2][2] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[1][2] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    if ((tmq.tab[2][2] == tmq.tab[2][1] && tmq.tab[2][2] == 1 && tmq.tab[2][0] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[1][0] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    else    if ((tmq.tab[0][2] == tmq.tab[1][2] && tmq.tab[0][2] == 1 && tmq.tab[2][2] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[2][1] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    else    if ((tmq.tab[2][2] == tmq.tab[1][2] && tmq.tab[2][2] == 1 && tmq.tab[0][2] == 0) && (tmq.tab[1][1] == 1 || tmq.tab[0][1] == 1))
      {
        if (tmq.tab[1][1] == 2)
        {
            ia.i.x = 1; ia.i.y = 1;
    ...
    else    if ((tmq.tab[2][2] == tmq.tab[1][1] && tmq.tab[2][2] == 1 && tmq.tab[0][0] == 0) && (tmq.tab[1][0] == 1 || tmq.tab[0][1] == 1))
      {
        if (tmq.tab[1][0] == 2)
        {
            ia.i.x = 1; ia.i.y = 0;
    ...
    else    if ((tmq.tab[1][0] == tmq.tab[1][1] && tmq.tab[1][0] == 1 && tmq.tab[1][2] == 0) && (tmq.tab[0][2] == 1 || tmq.tab[2][2] == 1))
      {
        if (tmq.tab[0][2] == 2)
        {
            ia.i.x = 0; ia.i.y = 2;
    ...
    else    if ((tmq.tab[1][2] == tmq.tab[1][1] && tmq.tab[1][1] == 1 && tmq.tab[1][0] == 0) && (tmq.tab[0][0] == 1 || tmq.tab[2][0] == 1))
      {
        if (tmq.tab[0][0] == 2)
        {
            ia.i.x = 0; ia.i.y = 0;
    ...
    else    if ((tmq.tab[0][1] == tmq.tab[1][1] && tmq.tab[1][1] == 1 && tmq.tab[2][1] == 0) && (tmq.tab[2][0] == 1 || tmq.tab[2][2] == 1))
      {
        if (tmq.tab[2][0] == 2)
        {
            ia.i.x = 2; ia.i.y = 0;
    ...
    else    if ((tmq.tab[2][1] == tmq.tab[1][1] && tmq.tab[1][1] == 1 && tmq.tab[0][1] == 0) && (tmq.tab[0][0] == 1 || tmq.tab[0][2] == 1))
      {
        if (tmq.tab[0][0] == 2)
        {
            ia.i.x = 0; ia.i.y = 0;
    ...
    else    if ((tmq.tab[0][0] == tmq.tab[1][1] && tmq.tab[1][1] == 1 && tmq.tab[2][2] == 0) && (tmq.tab[1][2] == 1 || tmq.tab[2][1] == 1))
      {
        if (tmq.tab[1][2] == 2)
        {
            ia.i.x = 1; ia.i.y = 2;
    ...
    else    if ((tmq.tab[2][2] == tmq.tab[1][1] && tmq.tab[1][1] == 1 && tmq.tab[0][0] == 0) && (tmq.tab[0][1] == 1 || tmq.tab[1][0] == 1))
      {
        if (tmq.tab[0][1] == 2)
        {
            ia.i.x = 0; ia.i.y = 1;
    ...
    else    if ((tmq.tab[0][2] == tmq.tab[1][1] && tmq.tab[1][1] == 1 && tmq.tab[2][0] == 0) && (tmq.tab[1][0] == 1 || tmq.tab[2][1] == 1))
      {
        if (tmq.tab[1][0] == 2)
        {
            ia.i.x = 1; ia.i.y = 0;
    ...
    else    if ((tmq.tab[2][0] == tmq.tab[1][1] && tmq.tab[1][1] == 1 && tmq.tab[0][2] == 0) && (tmq.tab[0][1] == 1 || tmq.tab[1][2] == 1))
      {
        if (tmq.tab[0][1] == 2)
        {
            ia.i.x = 0; ia.i.y = 1;
            ...
            while(z == 0)
                {
                    ...
                    {
                        ia.i.x = alea_int(2); ia.i.y = alea_int(2);
                        if ((ia.i.x != 0 && ia.i.y != 0) && (ia.i.x != 2 && ia.i.y != 2))
                        {
                            k = 99;
                        }
                    }
            ...
            while(z == 0)
                {
                    ...
                    {
                        ia.i.x = alea_int(2); ia.i.y = alea_int(2);
                        if ((ia.i.x != 0 && ia.i.y != 2) && (ia.i.x != 2 && ia.i.y != 0))
                        {
                            k = 99;
                        }
                    }
            ...
            while(z == 0)
                {
                    ...
                    {
                        ia.i.x = alea_int(2); ia.i.y = alea_int(2);
                        if ((ia.i.x != 1 && ia.i.y != 0) && (ia.i.x != 1 && ia.i.y != 2))
                        {
                            k = 99;
                        }
                    }
            ...
            while(z == 0)
                {
                    ...
                    {
                        ia.i.x = alea_int(2); ia.i.y = alea_int(2);
                        if ((ia.i.x != 0 && ia.i.y != 1) && (ia.i.x != 2 && ia.i.y != 1))
                        {
                            k = 99;
                        }
                    }
